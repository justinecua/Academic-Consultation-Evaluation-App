  ...
  const handleSubmit = async () => {
    ...
    for (let field of requiredFields) {
      if (!form[field] || form[field].trim() === '') {
        showMessage({
          message: `Please fill out ${field.replace('_', ' ')}`,
          type: 'danger',
        });
        return;
      }
      ...
      >
          ...
          <View style={styles.row}>
            <View style={styles.halfInput}>
              <FormField
                ...
                onChangeText={(val) =>
                  handleChange('course_description', val)
                }
              />
            </View>
            <View style={styles.halfInput}>
              <FormField
                ...
                onChangeText={(val) =>
                  handleChange('class_schedule', val)
                }
              />
            </View>
          </View>
          ...
          <View style={styles.row}>
            <View style={styles.halfInput}>
              <FormField
                ...
                onChangeText={(val) =>
                  handleChange('subject_grade', val)
                }
              />
            </View>
        ...
        <Section title="Consultation Notes">
          <FormTextArea
            ...
            onChangeText={(val) =>
              handleChange('difficulties_identified', val)
            }
          />
          ...
          <FormTextArea
            ...
            onChangeText={(val) =>
              handleChange('learning_assistance', val)
            }
          />
